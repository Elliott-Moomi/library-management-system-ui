...
//   try {
//     yield call(postData(bookPath, payload));
//   } catch (error) {
//     console.error(error);
//   }
// }
...
export function* fetchBooksSaga() {
  try {
    const responseData = yield call(axios.request({
      method: "get",
      url: bookPath,
      headers:{}
    }));
...
//   try {
//     yield call(putData(`${bookPath}/${payload.id}`, payload));
//   } catch (error) {
//     console.error(error);
//   }
// }
...
//   try {
//     yield call(removeData(`${bookPath}/${payload}`));
//   } catch (error) {
//     console.error(error);
//   }
// }
